...
INSERT INTO USER (USERNAME, PASSWORD, USER_STATUS, USER_ROLE_ID, FIRST_NAME, LAST_NAME, ADDRESS, EMAIL, PHONE_NUMBER) VALUES ('admin', '179AD45C6CE2CB97CF1029E212046E81', 'Employee', 1, 'Admin', 'Admin', 'Test Address 1/3', 'admin@example.com', '000111222');

INSERT INTO USER (USERNAME, PASSWORD, USER_STATUS, USER_ROLE_ID, FIRST_NAME, LAST_NAME, ADDRESS, EMAIL, PHONE_NUMBER) VALUES ('testEmployee', '179AD45C6CE2CB97CF1029E212046E81', 'Employee', 2, 'Jan', 'Kowalski', 'Test Address 1/1', 'test1@example.com', '111222333');

INSERT INTO USER (USERNAME, PASSWORD, USER_STATUS, USER_ROLE_ID, FIRST_NAME, LAST_NAME, ADDRESS, EMAIL, PHONE_NUMBER) VALUES ('testCustomer', '841C4221C2E7E0CEFBC0392A35222512', 'Customer', 3, 'Piotr', 'Nowak', 'Test Address 1/2', 'test2@example.com', '444555666');
